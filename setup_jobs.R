...
datasets = commands(
  sss=setup_sim(G=2^13, K=2^10, V=2, n_iter=50000, warmup=5000, init.iter=500),
  ssm=setup_sim(2^13, 2^10, 4, n_iter=50000, warmup=5000, init.iter=500),
  ssl=setup_sim(2^13, 2^10, 6, n_iter=50000, warmup=5000, init.iter=500),
  sms=setup_sim(2^13, 2^11, 2, n_iter=50000, warmup=5000, init.iter=500),
  smm=setup_sim(2^13, 2^11, 4, n_iter=50000, warmup=5000, init.iter=500),
  sml=setup_sim(2^13, 2^11, 6, n_iter=50000, warmup=5000, init.iter=500),
  sls=setup_sim(2^13, 2^12, 2, n_iter=50000, warmup=5000, init.iter=500),
  slm=setup_sim(2^13, 2^12, 4, n_iter=50000, warmup=5000, init.iter=500),
  sll=setup_sim(2^13, 2^12, 6, n_iter=50000, warmup=5000, init.iter=500),
